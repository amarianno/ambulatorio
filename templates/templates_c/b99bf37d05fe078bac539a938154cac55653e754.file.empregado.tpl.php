<?php /* Smarty version Smarty-3.1.13, created on 2014-04-02 13:36:18
        ...
        <tr>
            <td>
                ...
                <input id="txtAdmissao" name="txtAdmissao"
                       type="text" value="<?php echo $_smarty_tpl->tpl_vars['txtAdmissao']->value;?>
" maxlength="60"
        ...
        <tr>
            <td>
                ...
                <input id="txtDataNascimento" name="txtDataNascimento"
                       type="text" value="<?php echo $_smarty_tpl->tpl_vars['txtDataNascimento']->value;?>
" maxlength="20"
        ...
        <tr>
            <td>
                ...
                <input id="txtTelefone" name="txtTelefone"
                       type="text" value="<?php echo $_smarty_tpl->tpl_vars['txtTelefone']->value;?>
" maxlength="14"
