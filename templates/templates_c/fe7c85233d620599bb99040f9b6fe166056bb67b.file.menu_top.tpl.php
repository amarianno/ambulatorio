<?php /* Smarty version Smarty-3.1.13, created on 2014-04-01 15:21:32
...
<?php if ($_valid && !is_callable('content_513e393fc0d733_25231271')) {function content_513e393fc0d733_25231271($_smarty_tpl) {?><?php if ($_SESSION['perfil_usuario']=='1'){?>
    <!-- MENU -->
    <div id="menu">
        <!-- menu-holder -->
        <div id="menu-holder">
...
<?php }?>
<?php if ($_SESSION['perfil_usuario']=='2'){?>
    <!-- MENU -->
    <div id="menu">
        <!-- menu-holder -->
        <div id="menu-holder">
...
<?php }?>
<?php if ($_SESSION['perfil_usuario']=='3'){?>
    <!-- MENU -->
    <div id="menu">
        <!-- menu-holder -->
        <div id="menu-holder">
...
Usuário:<strong> <?php echo $_SESSION['nome_usuario'];?>
 </strong>
<!-- MAIN -->
<div id="main">
<!-- wrapper-main -->
